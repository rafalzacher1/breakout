...
paddle_control = False    # True is for keyboard and False is for mouse
...
def show_scores():
    draw_text(game_play_screen, "Score: {}". format(score), 22, 53, 300)
    draw_text(game_play_screen, "Bricks Remaining: {}".format(len(all_game_bricks)), 22, 100, 330)
#####################################
