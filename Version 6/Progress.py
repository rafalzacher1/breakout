...
class Progress():
    """Defines the progress class, which represents the UI components."""
    Text = None
    HEIGHT = None
    WIDTH = None
    CENTRE_Y = None
    ...
    def show_game_over(self, game_play_screen, background, background_rectangle, game_clock, FPS, score, level):
        """This tells the player that they have lost - it provides them with information from the current game play."""
        running = True
    ...
    def new_game(self):
        """Create a new game - set all game values to initial states."""
